...
public class EasyRestCall<T extends sendRestData, X> extends AsyncTask<Void, Void, Boolean> {
    ...
    /**
     * Base constructor for get petitions
     *
     * @param JsonResponseEntityClass
     */
    public EasyRestCall(Class<X> JsonResponseEntityClass) {
        ...
        fixedMethod = methodToCall = DefinitionsHttpMethods.METHOD_GET;
    }
     ...
     * @param EntityClass
     */
    public EasyRestCall(Class<T> EntityClass, HttpMethod Method) {
        this.entityClass = EntityClass;
        requestHeaders.setContentType(MediaType.APPLICATION_JSON);
